...
const DEFAULT_SITE = {
  ...
  faq: [
    ...
    { question: 'What if I already have a site I hate?', answer: "That's the Rebuild package ($150). I keep what's earning you traffic \u2014 page addresses, reviews, listings \u2014 and replace everything underneath. Your existing site stays up until the new one is ready to swap in." },
