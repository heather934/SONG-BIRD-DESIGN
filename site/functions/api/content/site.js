...
const DEFAULT_SITE = {
  ...
  faq: [
    ...
    { question: 'What if I already have a site I hate?', answer: "That's the Rebuild package ($1,200). I keep what's earning you traffic \u2014 page addresses, reviews, listings \u2014 and replace everything underneath. Your existing site stays up until the new one is ready to swap in." },
    ...
    { question: 'Can I edit it myself later?', answer: "Yes. Text, photos, hours, and prices are set up for you to change without touching code, and I'll record a short video walkthrough for your own site so you're not searching through generic help articles. Or skip it entirely with Care & Feeding ($65/month) \u2014 I make the edits for you." },
    { question: 'How do payments work?', answer: 'For the Starter Nest, Rebuild, or Full Build: half to reserve the build slot, half on launch day. No hourly billing and no surprise invoices \u2014 if the scope changes, we agree on the new number first. Care & Feeding is billed monthly, cancel anytime.' },
  ],
  contact: {
